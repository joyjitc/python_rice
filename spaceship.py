...
class Ship:
    ...
    def shoot(self):
        ...
        pos = [0,0] 
        pos[0] = vec[0]*45 + self.pos[0]
        pos[1] = vec[1]*45 + self.pos[1]
...
def draw(canvas):
    ...
    canvas.draw_text('Lives', (30, 40), 20, 'White', 'monospace')
    canvas.draw_text('Score', (700, 40), 20, 'White', 'monospace')
    canvas.draw_text(str(lives), (30, 65), 20, 'White', 'monospace')
    canvas.draw_text(str(score), (700, 65), 20, 'White', 'monospace')
            
# timer handler that spawns a rock    
def rock_spawner():
    global a_rock
    pos = [random.random()* WIDTH,random.random()* HEIGHT]
    vel = [random.random()* 8 - 4,random.random()* 8 - 4]
...
# initialize ship and two 0sprites
